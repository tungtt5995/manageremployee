...
//	@Qualifier("DepartDao")
	...
	public String insert(ModelMap model,@Validated @ModelAttribute("depart") Departs depart,BindingResult error) {
		if(error.hasErrors()) {
...
//		return "redirect:/depart/add";
	...
	public  String editDepart(ModelMap model, @PathVariable("id") Integer id) {
...
//		model.addAttribute("listDepart", departDao.listDeparts());
	...
	public String editDepart(ModelMap model, @PathVariable("id") Integer id, @ModelAttribute("depart") Departs departs) {
